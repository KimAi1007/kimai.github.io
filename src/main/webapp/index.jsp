            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                     <div class="row">
                        <div class="col-sm-6">
                           <h1 class="banner_taital">Beauty</h1>
         ...
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  ...
                  <p class="product_text">Outstanding skin care products are trusted by many users of our store</p>
               </div>
            </div>
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="about_taital_main">
                        ...
                        <p class="about_text">Our store is always dedicated to each customer. With a wide range of products for you to choose from, we will always give you a free consultation. Thank</p>
                  ...
                  <div class="col-sm-4">
                     ...
                     <div class="address_bt">
                        <ul>
                           <li>
                              <a href="#">
                              <i class="fa fa-map-marker" aria-hidden="true"></i><span class="padding_left10">Address : DaNang</span>
                              </a>
                           </li>
                           <li>
                              <a href="#">
                           ...
                           <li>
                              <a href="#">
                              <i class="fa fa-envelope" aria-hidden="true"></i><span class="padding_left10">Email : beauty@gmail.com</span>
                              </a>
                           </li>
                        </ul>
                     </div>
